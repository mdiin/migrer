...
(with-test
 (defn dependency-order
  ...
  (tst/is (= (list [1 #{}] [2 #{1}] [3 #{1 2}] [4 #{2 3}] [5 #{2 3 4}] [6 #{5}] [7 #{3 6}] [8 #{4 5 7}] [9 #{1 2 3 4 5 6 7 8}])
             (dependency-order (shuffle (list [1 #{}] [2 #{1}] [3 #{1 2}] [4 #{2 3}] [5 #{2 3 4}] [6 #{5}] [7 #{3 6}] [8 #{4 5 7}] [9 #{1 2 3 4 5 6 7 8}])))))
  (tst/is (= (list [1 #{}] [2 #{1}])
